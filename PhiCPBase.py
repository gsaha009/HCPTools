...
class PhiCPBase:
    ...
    def selcols(self, mask):
        #return {'taum': self.taum[mask], 
        #        'taup': self.taup[mask], 
        #        'taum_decay': self.taum_decay[mask], 
        #        'taup_decay': self.taup_decay[mask]}
    ...
    def get_evtinfo_rhorho(self):
        ...
        ispim = (taum_decay.pdgId == -211) | (taum_decay.pdgId == -311)
        ispip = (taup_decay.pdgId == 211) | (taup_decay.pdgId == 311)        
        
        p4_taum_nu = getp4(taum_decay[taum_decay.pdgId == 16]) # tau- nu
        p4_taum_pi = getp4(taum_decay[ispim]) # tau- pi-
        p4_taum_pi = setp4_(p4_taum_pi, 0.1396)
        
        p4_taum_pi0 = getp4(taum_decay[taum_decay.pdgId == 111]) # tau- pi0
        ...
        p4_taup_pi0 = getp4(taup_decay[taup_decay.pdgId == 111]) # tau+ pi0
